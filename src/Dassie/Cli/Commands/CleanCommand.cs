...
internal class CleanCommand : ICompilerCommand
{
    ...
    {
        if (args != null && args.Any(a => a == "-h" || a == "--help" || a == "-?"))
        {
            StringBuilder sb = new();

            sb.AppendLine();
            sb.AppendLine($"dc clean: {Description}");
            sb.AppendLine();
            sb.AppendLine("Usage: dc clean");
            sb.AppendLine();
            sb.AppendLine("Remarks:");
            sb.AppendLine(HelpCommand.FormatLines("This command only works when executed at the root level of a project or project group. It deletes all output and temporary files generated by the compiler. Warning: This command will delete all contents of the build directory, even those created by the user!", true, 4));
