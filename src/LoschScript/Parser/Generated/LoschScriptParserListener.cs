...
public interface ILoschScriptParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterAnonymous_function_expression([NotNull] LoschScriptParser.Anonymous_function_expressionContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>anonymous_function_expression</c>
	/// labeled alternative in <see cref="LoschScriptParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitAnonymous_function_expression([NotNull] LoschScriptParser.Anonymous_function_expressionContext context);
	/// <summary>
	/// Enter a parse tree produced by the <c>rethrow_exception</c>
	/// labeled alternative in <see cref="LoschScriptParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterRethrow_exception([NotNull] LoschScriptParser.Rethrow_exceptionContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterBlock_expression([NotNull] LoschScriptParser.Block_expressionContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>block_expression</c>
	/// labeled alternative in <see cref="LoschScriptParser.expression"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitBlock_expression([NotNull] LoschScriptParser.Block_expressionContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterAccess_modifier_member_group([NotNull] LoschScriptParser.Access_modifier_member_groupContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="LoschScriptParser.access_modifier_member_group"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitAccess_modifier_member_group([NotNull] LoschScriptParser.Access_modifier_member_groupContext context);
	/// <summary>
