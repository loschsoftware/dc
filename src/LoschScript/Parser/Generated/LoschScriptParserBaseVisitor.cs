...
public partial class LoschScriptParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ILoschScriptParserVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitList_initializer_expression([NotNull] LoschScriptParser.List_initializer_expressionContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="LoschScriptParser.array_type_specifier"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitArray_type_specifier([NotNull] LoschScriptParser.Array_type_specifierContext context) { return VisitChildren(context); }
	/// <summary>
