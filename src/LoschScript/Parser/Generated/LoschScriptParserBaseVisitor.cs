...
public partial class LoschScriptParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ILoschScriptParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="LoschScriptParser.macro_call"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitMacro_call([NotNull] LoschScriptParser.Macro_callContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitUnion_variable_type([NotNull] LoschScriptParser.Union_variable_typeContext context) { return VisitChildren(context); }
	/// <summary>
